...
public:
    ...
    void DrawLineToBuffer(int startX, int startY, int endX, int endY, D2D1::ColorF color);
    void DrawLineToBuffer_Reference(int startX, int startY, int endX, int endY, D2D1::ColorF color);

    void DrawCircleToBuffer(int originX, int originY, int radius, D2D1::ColorF color);
};
