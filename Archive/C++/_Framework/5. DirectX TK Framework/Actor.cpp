...
/// </summary>
/// <param name="frameName">: json파일에 기재된 파일명을 입력합니다. TexturePackerGUI 패킹을 기준으로 하며, "frames" 배열의 오브젝트에서 "filename"이 가리키는 이름을 입력해야 합니다.</param>
...
void Actor::Render(SpriteBatch* batch)
{
	...
	if (batch == nullptr || m_texture == nullptr)
		return;
